        ...
        private readonly MockRow[] mockTable =
            new[]
            {
                new MockRow
                {
                    Fields = new[]
                    {
                        new MockField {Name = "short_value", Type = typeof(Int16), Value = (short) 1},
                        new MockField {Name = "int_value", Type = typeof(Int32), Value = 1},
                        new MockField {Name = "long_value", Type = typeof(Int64), Value = (long)1},
                ...
                new MockRow
                {
                    Fields = new[]
                    {
                        new MockField {Name = "short_value", Type = typeof(Int16), Value = (short) 2},
                        new MockField {Name = "int_value", Type = typeof(Int32), Value = 2},
                        new MockField {Name = "long_value", Type = typeof(Int64), Value = (long)2},
